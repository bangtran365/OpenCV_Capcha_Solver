...
class ContourWithData():
    ...
    def checkIfContourIsValid(self):                            # this is oversimplified, for a production grade program
        print self.fltArea
        if (self.fltArea < MIN_CONTOUR_AREA) | (self.fltArea>MAX_CONTOUR_AREA): return False        # much better validity checking would be necessary
        return True
